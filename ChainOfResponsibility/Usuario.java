...
public class Usuario
{
	...
	{
		ObjetoBasico vehiculo1 = new Vehiculo("AUTO ++ KT500 Vehiculo de ocación en buen estado");
		System.out.println(vehiculo1.devuelveDescripcion());
		ObjetoBasico modelo1 = new Modelo("KT400","Vehiculo amplio y confortable");
		System.out.println(modelo1.devuelveDescripcion());
		...
		ObjetoBasico modelo2 = new Modelo("K700",null);
